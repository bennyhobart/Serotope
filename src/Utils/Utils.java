...
public class Utils {
	...
	public static final String[] CREATUREIMAGES = { CREATUREIMAGE1,
			CREATUREIMAGE2, CREATUREIMAGE3, CREATUREIMAGE4, CREATUREIMAGE5,
			CREATUREIMAGE6, CREATUREIMAGE7 };
	...
	// Modifiers to be applied to a creature by it's genes
	public static final int HEALTH_BUFF = 50;
	public static final int STAMINA_BUFF = 1;
